  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-header">
        <h3 class="box-title">Data Laporan Imunisasi</h3>
        <div class="box-body">
...
$total=$row->laki_laki + $row->perempuan; 
           ?>
          <tr>
            <td><?php echo $no; ?></td>
...
<td><?php echo $row->desa; ?></td>
  ...
  <td><?php echo $row->kategori; ?></td>
            ...
            <td><?php echo number_format($row->laki_laki); ?></td>
            <td><?php echo number_format($row->perempuan); ?></td>
 <td><?php echo number_format($total); ?> Orang</td>

             <td><a href="<?php echo base_url();?>dashboard/cetak_data_imun/<?php echo $row->id_imunisasi;?>">View</a>
</td>

             <td><a href="<?php echo base_url(); ?>dashboard/hapus_data_imun/<?php echo $row->id_imunisasi ; ?>">Delete</a></td>
